  * this repository contains only libraries for different programming languages and is only useful for software developers. Most of the packages contain the source code.
